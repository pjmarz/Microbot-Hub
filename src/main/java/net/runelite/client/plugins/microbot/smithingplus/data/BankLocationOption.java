 ...
 *
 * <p>Copied verbatim from {@code miningplus} -> {@code smeltingplus} skill-agnostic dataset.
 * Coordinates from OSRS Wiki bank-booth tiles. Re-audit before v1.0.
 *
 * <h2>Audit log</h2>
 * <ul>
 *   <li><b>2026-05-21 (v0.3.2):</b> Added Fadli's Al Kharid Arena bank (F2P, ~75 tiles from
...
public enum BankLocationOption {
    ...
    // v0.3.1 display polish: shortened to fit dropdown width.
    ...
    // v0.3.2: Fadli's bank at Emir's Arena -- F2P, much closer to Al Kharid Mine.
